...
export const translations = {
  en: {
    ...
    newFetchingModels: "Fetching available models...",
    newModelsLoaded: "Models loaded",
    newModelsFallback: "Could not fetch models — using defaults",
  ...
  pt: {
    ...
    newFetchingModels: "Buscando modelos disponíveis...",
    newModelsLoaded: "Modelos carregados",
    newModelsFallback: "Não foi possível buscar modelos — usando padrões",
